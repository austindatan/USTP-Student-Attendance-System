...
useEffect(() => {
  ...
  const fetchCourses = async () => {
    try {
      const res = await axios.get(
        `http://localhost/ustp-student-attendance/api/student_backend/get_student_courses.php?student_details_id=${studentDetailsId}`
      );
  ...
  useEffect(() => {
    ...
    try {
        const res = await axios.get(`http://localhost/ustp-student-attendance/api/student_backend/get_instructor_by_course.php?student_details_id=${studentDetailsId}&course_id=${courseId}`);
