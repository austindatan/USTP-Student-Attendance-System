...
function ClassCard({ code, title, room, schedule, bgImage, bgColor = "#0097b2" }) {
  ...
  return (
    <div
      className="w-full max-w-xs rounded-2xl shadow-lg overflow-hidden cursor-pointer"
      style={{ minHeight: '225px' }}
      onClick={handleClick}
    >
      <div
        className="p-6 h-32 rounded-t-2xl relative z-10 flex flex-col justify-between"
        style={{
      ...
      >
        ...
        <h2 className="text-white text-lg font-bold leading-tight max-w-[140px]">
          {title}
        </h2>
