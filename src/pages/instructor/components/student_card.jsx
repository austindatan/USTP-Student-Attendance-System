    ...
    if (loading) {
        return (
            <div className="flex justify-start">
                <div
                    className="animate-pulse cursor-pointer bg-white border-2 border-[#e4eae9] rounded-[20px] flex flex-col justify-between"
                    style={{ width: "9rem" }} // Optional fixed width to match real card
                >
                    <div className="overflow-hidden rounded-t-[20px] flex justify-center">
                        <img
                            src="assets/white_placeholder2.jpg" // Your placeholder image here
