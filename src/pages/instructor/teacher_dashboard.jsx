...
export default function Teacher_Dashboard({ selectedDate }) {
    ...
    async function fetchDashboardStats() {
      ...
      try {
        ...
        const response = await fetch(
          `http://localhost/ustp-student-attendance/api/instructor_backend/get_teacher_dashboard_stats.php?instructor_id=${instructor.instructor_id}&date=${dateStr}`
        );
  ...
  useEffect(() => {
    ...
    const fetchSimplifiedNotifications = async () => {
      try {
        const res = await fetch(`http://localhost/ustp-student-attendance/api/instructor_backend/get_recent_req_notif.php?instructor_id=${instructor.instructor_id}`);
  ...
  useEffect(() => {
    const fetchWeeklyAttendance = async () => {
      if (!instructor?.instructor_id) return;
      try {
        const res = await fetch(`http://localhost/ustp-student-attendance/api/instructor_backend/get_weekly_attendance.php?instructor_id=${instructor.instructor_id}`);
        const data = await res.json();
  ...
  useEffect(() => {
    const fetchSections = async () => {
      if (!instructor?.instructor_id) return;
      try {
        const res = await fetch(`http://localhost/ustp-student-attendance/api/instructor_backend/get_sections.php?instructor_id=${instructor.instructor_id}`);
        const data = await res.json();
        setSections(data);
      } catch (err) {
