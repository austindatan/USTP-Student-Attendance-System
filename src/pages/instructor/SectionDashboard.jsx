...
export default function TeacherDashboard({ selectedDate }) {
    ...
    const handleSaveImage = async () => {
        ...
        try {
            const response = await fetch('http://localhost/ustp-student-attendance-system/api/instructor-backend/UpdateSection_image.php', {
                method: 'POST',
    ...
    useEffect(() => {
        ...
        if (!sectionInfo && sectionId) {
            async function fetchSectionInfo() {
                try {
                    const response = await fetch(`http://localhost/ustp-student-attendance-system/api/instructor-backend/GetSection_info.php?section_id=${sectionId}`);
                    if (!response.ok) {
    ...
    useEffect(() => {
        ...
        const fetchLockStatus = async () => {
            try {
                const response = await fetch('http://localhost/ustp-student-attendance-system/api/instructor-backend/GetAttendanceLockStatus.php', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({
        ...
        const fetchStudents = async () => {
            try {
                ...
                const response = await fetch(
                    `http://localhost/ustp-student-attendance-system/api/instructor-backend/GetStudents.php?date=${dateStr}&instructor_id=${instructor.instructor_id}&section_id=${sectionId}&course_id=${courseId}&_t=${new Date().getTime()}`
                );
    ...
    const toggleAttendance = async (student) => {
        ...
        try {
            const response = await fetch('http://localhost/ustp-student-attendance-system/api/instructor-backend/SaveAttendance.php', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    useEffect(() => {
        const fetchDropdownStudents = async () => {
            try {
                ...
                const response = await fetch(`http://localhost/ustp-student-attendance-system/api/instructor-backend/StudentDropdown.php?instructor_id=${instructor.instructor_id}&section_id=${sectionId}&course_id=${courseId}`);
    ...
    const handleAddDropRequest = async () => {
        ...
        try {
            const response = await fetch('http://localhost/ustp-student-attendance-system/api/instructor-backend/AddDropRequest.php', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    const handleUnlockAttendance = async () => {
        ...
        try {
            const response = await fetch('http://localhost/ustp-student-attendance-system/api/instructor-backend/unLockAttendance.php', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
                    section_id: sectionInfo.section_id,
    ...
    const handleLockAttendanceConfirm = async () => {
        ...
        try {
            const response = await fetch('http://localhost/ustp-student-attendance-system/api/instructor-backend/LockAttendance.php', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
                    section_id: sectionInfo.section_id,
                                        ...
                                        <div ref={colorModalRef} className="absolute right-0 mt-2 w-79 bg-white p-4 rounded-lg shadow-xl z-50 text-center border border-gray-200">
                                            ...
                                            <div className="flex justify-center gap-4">
                                                <button
                                                    onClick={async () => {
                                                        try {
                                                            const response = await fetch('http://localhost/ustp-student-attendance-system/api/instructor-backend/UpdateSection_color.php', {
                                                                method: 'POST',
                                                                headers: { 'Content-Type': 'application/json' },
                                                                body: JSON.stringify({
                                                                    section_course_id: sectionInfo?.section_course_id,
