...
const ExcuseRequestsPage = () => {
  ...
  const fetchRequests = (currentInstructorId, showSkeleton = true) => {
    ...
    fetch(`http://localhost/ustp-student-attendance-system/api/instructor-backend/GetExcusedReq.php?instructor_id=${currentInstructorId}`)
      .then(res => {
        if (!res.ok) {
  ...
  const confirmAction = async () => {
    ...
    if (modal.type === "approve" || modal.type === "reject") {
      ...
      endpoint = "http://localhost/ustp-student-attendance-system/api/instructor-backend/UpdateExcuseReq.php";
      method = "PUT";
      ...
      endpoint = "http://localhost/ustp-student-attendance-system/api/instructor-backend/DeleteExcuseReq.php";
      method = "DELETE";
