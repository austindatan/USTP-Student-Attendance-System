...
export default function Admin_Sections() {
    ...
    useEffect(() => {
        axios.get('http://localhost/ustp-student-attendance/api/admin_backend/section_with_details.php')
            .then(res => {
    ...
    const confirmDelete = () => {
        axios.post('http://localhost/ustp-student-attendance/api/admin_backend/delete_section.php', {
            _method: 'DELETE',
