...
export default function EditStudent() {
    ...
    const fetchSections = useCallback(async (yearLevelId, semesterId) => {
        ...
        try {
            ...
            const secRes = await axios.get('http://localhost/ustp-student-attendance-system/api/admin_backend/section_dropdown.php', { params });
        ...
        const fetchData = async () => {
            ...
            try {
                const [progRes, yearRes, semRes, studentRes] = await Promise.all([
                    axios.get('http://localhost/ustp-student-attendance-system/api/admin_backend/pd_dropdown.php'),
                    axios.get('http://localhost/ustp-student-attendance-system/api/admin_backend/get_year_levels.php'),
                    axios.get('http://localhost/ustp-student-attendance-system/api/admin_backend/get_semesters.php'),
                    axios.get(`http://localhost/ustp-student-attendance-system/api/admin_backend/student_get_api.php?student_id=${student_id}`),
                ]);
                    ...
                    (studentData.enrollments || []).map(async (enrollment) => {
                        if (enrollment.year_level_id && enrollment.semester_id) {
                            ...
                            if (!newSectionsCache[cacheKey]) {
                                try {
                                    const res = await axios.get('http://localhost/ustp-student-attendance-system/api/admin_backend/section_dropdown.php', {
    ...
    const handleConfirmUpdate = async () => {
        ...
        try {
            const res = await axios.post(
                `http://localhost/ustp-student-attendance-system/api/admin_backend/student_update_api.php?student_id=${student_id}`,
                submissionData,
                {
                    headers: {
