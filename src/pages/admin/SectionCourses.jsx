...
function SectionCourses() {
    ...
    const fetchSectionCourses = async () => {
        try {
            const response = await axios.get(`http://localhost/ustp-student-attendance/api/admin_backend/section_courses.php?section_id=${sectionId}`);
    ...
    const confirmDelete = async () => {
        ...
        try {
            const response = await axios.post('http://localhost/ustp-student-attendance/api/admin_backend/delete_sectioncourse.php', {
                _method: 'DELETE',
