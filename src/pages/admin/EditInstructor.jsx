...
export default function EditInstructor() {
    ...
    useEffect(() => {
        axios
            .get(`http://localhost/ustp-student-attendance/api/admin_backend/get_instructor_info.php?instructor_id=${instructor_id}`)
            .then(res => {
    ...
    const handleConfirmEditInstructor = async () => {
        ...
        try {
            const res = await axios.post(
                'http://localhost/ustp-student-attendance/api/admin_backend/edit_profile.php',
                data,
                {
