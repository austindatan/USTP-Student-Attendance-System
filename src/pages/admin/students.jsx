  ...
  const fetchStudents = async () => {
    ...
    try {
      const res = await axios.get(
        "http://localhost/ustp-student-attendance-system/api/admin_backend/student_api.php"
      );
  ...
  const confirmDelete = async () => {
    ...
    try {
      const res = await axios.post(
        'http://localhost/ustp-student-attendance-system/api/admin_backend/delete_student.php',
        {
