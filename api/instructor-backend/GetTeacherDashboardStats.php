...
if ($row4 = $res4->fetch_assoc()) {
    $ExcuseRequests_result = intval($row4['pending_ExcuseRequests']);
}
$stmt4->close();
...
echo json_encode([
    ...
    "excuseRequests" => $ExcuseRequests_result
]);
