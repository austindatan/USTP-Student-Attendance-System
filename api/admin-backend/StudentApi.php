...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    $query = "
        ...
        INNER JOIN
            SectionCourses sc ON sd.section_course_id = sc.section_course_id -- New join to SectionCourses
        INNER JOIN
            section sec ON sec.section_id = sc.section_id -- Join to section via SectionCourses
        INNER JOIN
            course c ON c.course_id = sc.course_id -- Join to course via SectionCourses
        INNER JOIN
