<?php
// UpdateSection.php (Already mostly correct based on your provided code)
...
if ($stmt === false) {
    error_log("Failed to prepare statement in UpdateSection.php: " . $conn->error);
...
if ($stmt->execute()) {
    ...
    error_log("Error executing statement in UpdateSection.php: " . $stmt->error);
