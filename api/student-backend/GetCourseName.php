...
if (isset($_GET['student_id']) && isset($_GET['course_code'])) {
    ...
    $stmt = $conn->prepare("
        SELECT
            course.course_name,
            SectionCourses.image,  -- Added image column
            SectionCourses.hexcode -- Added hexcode column
        FROM student_details
        INNER JOIN SectionCourses ON SectionCourses.section_course_id = student_details.section_course_id
        INNER JOIN course ON course.course_id = SectionCourses.course_id
