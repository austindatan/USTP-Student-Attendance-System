...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    $stmt = "
        ...
        INNER JOIN instructor ON instructor.instructor_id = attendance.instructor_id
        INNER JOIN section ON section.section_id = attendance.section_id
        INNER JOIN course ON course.course_id = section.course_id
        INNER JOIN program_details ON program_details.program_details_id = attendance.program_details_id
